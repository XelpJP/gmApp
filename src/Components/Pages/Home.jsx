...
const Home = () => {
  ...
  return (
    <Box>
      <Box>
        <Image src='https://www.farmdidi.com/cdn/shop/articles/Blog-post-revised_1445x.webp?v=1670659916' alt='' height={650} width={"100%"} objectFit={"fill"} />
      </Box>
      <Box display={"flex"} justifyContent={"center"} p={5}>
        <Text as={"b"} fontSize={"2xl"} onClick={handleClick} cursor={"pointer"}>Discover Our Premium Range & Enjoy True Taste</Text>
      </Box>
      <Box>
